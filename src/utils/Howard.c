...
static void Display_Policy(int *pi,double *c,int nnodes)
{
    int i;
...
static void Display_Semi_Policy(int *pi,double *c,double *tau, int nnodes)
{
    int i;
    printf("DISPLAYING POLICY nnodes=%d\n",nnodes);
    for (i=0; i<nnodes; i++)
...
#if 0
static void Display_Max_Policy(int *pi,int nnodes)
{
    int i;
    for (i=0; i<nnodes; i++)
    {
...
static void Display_Vector_String(int nnodes, double *v,char *s)
{
    int i;
    for (i=0; i<nnodes; i++)
    {
...
static void Display_Min_Max_Function(int narcs, int *ij,double *A,int *P)
{
    int i;
...
static void Display_Vector(int nnodes, double *v)
{
    int i;
    for (i=0; i<nnodes; i++)
    {
...
static void Display_Sparse_Matrix(int narcs, int *ij,double *A)
{
    int i;
    for (i=0;i<narcs; i++)
    {
...
static void Display_Semi_Sparse_Matrix(int narcs, int *ij,double *A, double *t)
{
    int i;
    for (i=0;i<narcs; i++)
    {
...
int Howard(int *IJ, double *A,int NNODES,int NARCS,double *CHI,
