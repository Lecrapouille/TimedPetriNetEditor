...
TEST(TestPetriNet, TestLoadedNet)
{
    ...
    ASSERT_EQ(net.m_arcs[0].duration, 0.0f);
    ...
    ASSERT_EQ(net.m_arcs[2].duration, 0.0f);
    ...
    ASSERT_EQ(net.m_arcs[4].duration, 0.0f);
    ...
    ASSERT_EQ(net.m_arcs[7].duration, 0.0f);
    ...
    ASSERT_EQ(net.m_arcs[9].duration, 0.0f);
