...
TEST(TestPetriNet, TestAnimatedTokenCreation)
{
    ...
    ASSERT_NEAR(at1.speed, norm / 10.0f, 0.0001f);
    ...
    ASSERT_NEAR(at2.speed, norm / 10.0f, 0.0001f);
    ...
    ASSERT_NEAR(at3.speed, norm / 10.0f, 0.0001f);
...
TEST(TestPetriNet, TestAnimatedTokenUpdate)
{
    ...
    ASSERT_NEAR(at1.speed, 2.0f, 0.0001f); // 20 units of distance / 10 units of time

    // 1st unit of time
    ASSERT_EQ(at1.update(1.0f), false);
    ASSERT_NEAR(at1.offset, 0.1f, 0.0001f);
    ASSERT_NEAR(at1.x, 2.0f, 0.0001f);
    ASSERT_NEAR(at1.y, 0.0f, 0.0001f);

    // 2nd unit of time
    ASSERT_EQ(at1.update(1.0f), false);
    ASSERT_NEAR(at1.offset, 0.2f, 0.0001f);
    ASSERT_NEAR(at1.x, 4.0f, 0.0001f);
    ASSERT_NEAR(at1.y, 0.0f, 0.0001f);

    // 9th unit of time
    ASSERT_EQ(at1.update(7.0f), false);
    ASSERT_NEAR(at1.offset, 0.9f, 0.0001f);
    ASSERT_NEAR(at1.x, 18.0f, 0.0001f);
    ASSERT_NEAR(at1.y, 0.0f, 0.0001f);

    // 10th unit of time
    ASSERT_EQ(at1.update(1.0001f), true);
    ASSERT_NEAR(at1.offset, 1.0f, 0.0001f);
    ASSERT_NEAR(at1.x, 20.0f, 0.01f);
    ASSERT_NEAR(at1.y, 0.0f, 0.0001f);
}
